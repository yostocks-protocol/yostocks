...
test('stock card: name, price, one verdict line; provider details only behind Details', () => {
  ...
  assert.deepEqual(ui.stockButtons('i', 'NVDA', true).inline_keyboard.map((r) => r.map((b) => b.text)), [['Buy $5', 'Buy $10', 'Buy $25'], ['✏️ Other', 'ℹ️ Details', '🏠 Home'], ['🎯 Buy if it drops', '🔁 Auto-invest']])
})
