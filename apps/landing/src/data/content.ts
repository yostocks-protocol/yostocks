...
export const features: Feature[] = [
  ...
  { icon: '🔗', title: 'Your wallet, your limits', body: 'Tap <b>Connect Binance to buy</b> and approve in the Binance app. Every trade runs on your own Agentic Wallet, and <b>🛡 Safety</b> shows your daily limit and cleans up token approvals.' },
  ...
  { icon: '🎯', title: 'Works while you sleep', body: '<b>Buy if it drops</b>, <b>sell higher</b> and <b>🔁 auto-invest</b>: orders wait in your Binance wallet, and the bot messages you when one fills.' },
